...
const CardGrande2 = () => {
  ...
  // Si segundoPlato aún no está definido, puedes mostrar un mensaje de carga o simplemente no renderizar nada
  if (!segundoPlato) {
    return null;
  }
    ...
    <>
      ...
      <div className="CardGrande2">
        <div className="CardGrande_Contenido2">
          <div className="CardGrande_Contenido_titulo2">{segundoPlato.nombre_plato}</div>
          <div className="CardGrande_Contenido_Descipcion2">{segundoPlato.descripcion}</div>      <br /> <br /> <br /><br />
          <span>Categoría: {segundoPlato.nombre_categoria}.</span>
          <br />
          <span>Departamento: {segundoPlato.nombre_departamento}.</span>
          <br />
          <span className='CardGrande_Contenido_Ingredientes2'>Ingredientes: {segundoPlato.ingredientes}.</span>
        </div>
